            ...
            <div className="flex gap-2">
              {githubLink && (
                <a
                  ...
                  className="text-lg w-10 h-10 flex justify-center items-center rounded-full bg-black text-gray-400 hover:text-designColor transition-colors duration-300"
                >
                  <BsGithub />
                </a>
              )}
